      ...
      <div class="auth-card">
        ...
        <form method="post" class="auth-form" id="login-form" novalidate>
          <div class="form-group">
            ...
            <input type="email" name="email" id="email" placeholder="Enter your email" value="<?php echo $_POST['email'] ?? ''; ?>">
          ...
          <div class="form-group form-options">
            ...
            <a class="link" href="/auth.php?page=forgot-password">Forgot password?</a>
          </div>
          ...
          <div class="auth-footer">
            <p>Don't have an account? <a class="link" href="/auth.php?page=signup">Sign up</a></p>
          </div>
        </form>
      </div>
    </div>
